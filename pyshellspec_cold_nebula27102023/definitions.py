...
location_definitions = [
        ['chara', 'npoi', 'alma', 'VLT'],
        [34.223759, 35.0959],
        [-118.061645, -111.5339], # co je tohle jako za číslo????
        [-23.029, -67.755],
        [-24.62794830, -70.40479659]
    ]
...
object_definitions = {
    ...
    'nebula': [
        ...
        dict(name='rinnb', value=6., unit='solRad', vmin=0., vmax=100000., fitted=False, dtype=float, docstring=''),
        dict(name='routnb', value=30., unit='solRad', vmin=0., vmax=100000., fitted=False, dtype=float, docstring=''),
    ...
    'shell': [
        ...
        dict(name='evelsh', value=1.0, unit=None, vmin=-2.0, vmax=5.0, fitted=False, dtype=float, docstring=''),
