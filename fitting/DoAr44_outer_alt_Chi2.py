...
def main():
    ...
    itf.set_parameter('ior'    , value=3*pixels//4     , fitted=False, vmin=0, vmax=10000)
    ...
    # NEBULA
    itf.set_parameter('rinnb'   , value=35*215, fitted=True, vmin=0.0, vmax=60*215)
    itf.set_parameter('routnb'   , value=80*215, fitted=True, vmin=0.0, vmax=90*215)
    ...
    itf.set_parameter('densnb'  , value=5e-12, fitted=True, vmin=1e-15, vmax=1e-10)
    ...
    itf.set_parameter('edennb'  , value=-1, fitted=False, vmin=-3.0, vmax=-0.5)
    itf.set_parameter('etmpnb'  , value=-2, fitted=False, vmin=-3.0, vmax=3.0)
    itf.set_parameter('aneb'    , value=0.1, fitted=False, vmin=0.0, vmax=12.0)
    # END NEBULA -------------------------------------------------
