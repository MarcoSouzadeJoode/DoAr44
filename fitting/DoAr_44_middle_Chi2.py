...
def main():
    ...
    # ALMA data
    #IF_data_filename = '../data_synthetic_alma/ALMA_reduced.dat'
    ...
    # VLTI data
    #IF_data_filename = '../data/MATISSE_N2'
    ...
    SED_data_filename = '../data/SED_NEBULA_DR_cgs_flux_mid'
    obs.append(pyshellspec3.SEDData(filename=SED_data_filename))
    
    
    #SED_data_filename = '../data_synthetic_alma/SED_NEBULA_DR_cgs_flux_mid'
    #obs.append(pyshellspec3.SEDData(filename=SED_data_filename))

    #SED_data_filename = '../data_synthetic_alma/ALMA_band10_just'
    #obs.append(pyshellspec3.SEDData(filename=SED_data_filename))
    
    #SED_data_filename = '../data_synthetic_alma/SED_NEBULA_DR_cgs_outer'
    #obs.append(pyshellspec3.SEDData(filename=SED_data_filename))
    ...
    # modified
    itf.set_parameter('Tstar', value=4700)
    ...
    itf.set_parameter('iot'    , value=int(32/40 *60 )    , fitted=False, vmin=0, vmax=10000)
    # NEBULA -----------------------------------------------
    ...
    itf.set_parameter('rindc'   , value=0.5 * 215, fitted=False, vmin=0.0, vmax=20000)
    itf.set_parameter('routdc'   , value=1 * 215, fitted=False, vmin=0.0, vmax=20000)
    
    intemp = 650.0
    itf.set_parameter('tempdc'   , value=intemp, fitted=False, vmin=0.0, vmax=20000)
    
    densdc = 1e-10
    itf.set_parameter('densdc'  , value=densdc, fitted=True, vmin=0.1, vmax=500.0)

    itf.set_parameter('etmpdc'  , value=-0.3, fitted=True, vmin=0.1, vmax=500.0)
    itf.set_parameter('dsttdc'  , value=intemp, fitted=True, vmin=0.1, vmax=500.0)
    itf.set_parameter('dstddc'  , value=densdc*metallicity, fitted=True, vmin=0.0, vmax=5.0)
    
    
    # NEBULA
  
    itf.set_parameter('rinnb'   , value=0.2*215, fitted=True, vmin=0.0, vmax=60*215)
    itf.set_parameter('routnb'   , value=8*215, fitted=True, vmin=0.0, vmax=90*215)
    ...
    itf.set_parameter('tempnb'  , value=temp, fitted=True, vmin=10., vmax=5000.)
    itf.set_parameter('densnb'  , value=dstdnb/metallicity, fitted=True, vmin=1e-15, vmax=1e-10)
    
    
    itf.set_parameter('dsttnb'  , value=temp, fitted=True, vmin=0.1, vmax=500.0)
    itf.set_parameter('dstdnb'  , value=dstdnb, fitted=True, vmin=1e-17, vmax=1e-11)
    itf.set_parameter('hcnb'  , value=1, fitted=True, vmin=1e-17, vmax=1e-11)

    
    itf.set_parameter('vtrbnb'  , value=1.0, fitted=False, vmin=0.0, vmax=100.0)
    itf.set_parameter('edennb'  , value=-1.3, fitted=False, vmin=-3.0, vmax=-0.5)
    itf.set_parameter('etmpnb'  , value=-0.6, fitted=False, vmin=-3.0, vmax=3.0)
    itf.set_parameter('aneb'    , value=1, fitted=False, vmin=0.0, vmax=12.0)
    # END NEBULA -------------------------------------------------
